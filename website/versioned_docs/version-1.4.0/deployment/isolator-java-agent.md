...
Download both jars from the [1.4.0 release](https://github.com/prometheus/jmx_exporter/releases/tag/1.4.0):

- `jmx_prometheus_isolator_javaagent-1.4.0.jar`
- `jmx_prometheus_javaagent-1.4.0.jar`

## Argument format

```text
-javaagent:jmx_prometheus_isolator_javaagent-1.4.0.jar=<EXPORTER_JAVA_AGENT_JAR>=<JAVA_AGENT_ARGUMENT>[,<EXPORTER_JAVA_AGENT_JAR>=<JAVA_AGENT_ARGUMENT>]
```
...
```bash
java -javaagent:jmx_prometheus_isolator_javaagent-1.4.0.jar=jmx_prometheus_javaagent-1.4.0.jar=8080:exporter.yaml,jmx_prometheus_javaagent-1.4.0.jar=8081:exporter2.yaml -jar your-application.jar
```
