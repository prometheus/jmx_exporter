...
JMX Exporter 1.4.0 can expose metrics over HTTP, export through OpenTelemetry, or run both exporters from one configuration.
...
- Java agent: `-javaagent:jmx_prometheus_javaagent-1.4.0.jar=9404:exporter.yaml`
- Standalone: `java -jar jmx_prometheus_standalone-1.4.0.jar 9404 exporter.yaml`
