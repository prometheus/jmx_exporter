...
HTTP Basic `password` supports variable resolution:
...
The plugin class must be available on the exporter classpath and must implement the authenticator contract used by JMX Exporter 1.4.0.
