...
Download `jmx_prometheus_javaagent-1.5.0.jar` from the [1.5.0 release](https://github.com/prometheus/jmx_exporter/releases/download/1.5.0/jmx_prometheus_javaagent-1.5.0.jar).
...
```bash
java -javaagent:jmx_prometheus_javaagent-1.5.0.jar=9404:exporter.yaml -jar your-application.jar
```
...
```bash
java -javaagent:jmx_prometheus_javaagent-1.5.0.jar=exporter.yaml -jar your-application.jar
```
