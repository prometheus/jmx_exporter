...
JMX Exporter 1.5.0 exposes constructors for loading YAML configuration from a file, string, or input stream. The file constructor can also specify collector mode.
