...
Download [`jmx_prometheus_javaagent-1.5.0.jar`](https://github.com/prometheus/jmx_exporter/releases/download/1.5.0/jmx_prometheus_javaagent-1.5.0.jar) from the 1.5.0 release.
