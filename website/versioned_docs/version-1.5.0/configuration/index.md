...
Only document and use keys that are supported by the 1.5.0 implementation. The [configuration reference](../reference/configuration) lists the source-backed keys.
