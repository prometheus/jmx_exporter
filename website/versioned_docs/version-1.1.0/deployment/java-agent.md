...
Download `jmx_prometheus_javaagent-1.1.0.jar` from the [1.1.0 release](https://github.com/prometheus/jmx_exporter/releases/download/1.1.0/jmx_prometheus_javaagent-1.1.0.jar).
