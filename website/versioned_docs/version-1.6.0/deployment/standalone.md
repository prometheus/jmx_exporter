...
Download `jmx_prometheus_standalone-1.6.0.jar` from the [1.6.0 release](https://github.com/prometheus/jmx_exporter/releases/download/1.6.0/jmx_prometheus_standalone-1.6.0.jar).
...
A map form is also supported for remote JMX keystore, truststore, protocols, and ciphers. See [SSL configuration](../configuration/ssl).
