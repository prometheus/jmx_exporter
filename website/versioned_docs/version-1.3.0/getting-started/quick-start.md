...
Download [`jmx_prometheus_javaagent-1.3.0.jar`](https://github.com/prometheus/jmx_exporter/releases/download/1.3.0/jmx_prometheus_javaagent-1.3.0.jar) from the 1.3.0 release.
...
```bash
java -javaagent:jmx_prometheus_javaagent-1.3.0.jar=9404:exporter.yaml -jar your-application.jar
```
