...
Download `jmx_prometheus_standalone-1.3.0.jar` from the [1.3.0 release](https://github.com/prometheus/jmx_exporter/releases/download/1.3.0/jmx_prometheus_standalone-1.3.0.jar).
...
```bash
java -jar jmx_prometheus_standalone-1.3.0.jar 9404 exporter.yaml
```
