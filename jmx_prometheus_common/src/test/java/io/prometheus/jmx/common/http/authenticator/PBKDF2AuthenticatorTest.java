...
public class PBKDF2AuthenticatorTest extends BaseAuthenticatorTest {
    ...
    @Test
    public void testRepeatedSuccessReturnsTrue() throws Exception {
    ...
    @Test
    public void testRepeatedFailureReturnsFalse() throws Exception {
        PBKDF2Authenticator authenticator = createPBKDF2WithHmacSHA256Authenticator();
    ...
    @Test
    public void testMixedSequenceIsStable() throws Exception {
        PBKDF2Authenticator authenticator = createPBKDF2WithHmacSHA256Authenticator();
    ...
    private PBKDF2Authenticator createPBKDF2WithHmacSHA256Authenticator() throws Exception {
        ...
        return new PBKDF2Authenticator("/", VALID_USERNAME, hash, algorithm, SALT, iterations, keyLength);
    }
}
