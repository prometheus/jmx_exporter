...
public class BaseAuthenticatorTest {
    ...
    protected static final String[] TEST_USERNAMES = new String[] {"Prometheus", "prometheus", "bad", "", null};
    protected static final String[] TEST_PASSWORDS = new String[] {"secret", "Secret", "bad", "", null};
