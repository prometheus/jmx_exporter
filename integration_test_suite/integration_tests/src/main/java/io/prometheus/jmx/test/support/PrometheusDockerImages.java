...
public final class PrometheusDockerImages {
    ...
    private static final String QUICK_TEST_DOCKER_IMAGES_RESOURCE = "/quick-test-prometheus-docker-images.txt";
    ...
    private static final List<String> QUICK_TEST_DOCKER_IMAGES =
            DockerImagesSupport.load(QUICK_TEST_DOCKER_IMAGES_RESOURCE, PrometheusDockerImages.class);
     ...
     * property {@code prometheus.docker.images}. If neither is set, returns the quick test image list.
