...
public class SSLNoAuthWithCustomMetricsPathTest {
    ...
    public static Action factory() throws Throwable {
        var environments =
                JmxExporterTestEnvironment.createTestEnvironments(SSLNoAuthWithCustomMetricsPathTest.class).stream()
        ...
        return Each.parallel(
                        SSLNoAuthWithCustomMetricsPathTest.class.getName(),
                        environments,
                        environment -> instance(
                                        environment.name(), () -> new SSLNoAuthWithCustomMetricsPathTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        SSLNoAuthWithCustomMetricsPathTest.class,
                                                        SSLNoAuthWithCustomMetricsPathTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                SSLNoAuthWithCustomMetricsPathTest.class,
                                                                SSLNoAuthWithCustomMetricsPathTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                SSLNoAuthWithCustomMetricsPathTest.class,
                                                                SSLNoAuthWithCustomMetricsPathTest
                                                                        ::testDefaultTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        SSLNoAuthWithCustomMetricsPathTest.class,
                                                        SSLNoAuthWithCustomMetricsPathTest::tearDown)))))
                .build();
    }

    private SSLNoAuthWithCustomMetricsPathTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(SSLNoAuthWithCustomMetricsPathTest.class, javaDockerImage, mode, metrics);
    }
}
