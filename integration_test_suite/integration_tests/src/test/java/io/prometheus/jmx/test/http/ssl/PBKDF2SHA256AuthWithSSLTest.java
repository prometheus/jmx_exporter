...
public class PBKDF2SHA256AuthWithSSLTest {
    ...
    private PBKDF2SHA256AuthWithSSLTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        var environments = JmxExporterTestEnvironment.createTestEnvironments(PBKDF2SHA256AuthWithSSLTest.class).stream()
        ...
        return Each.parallel(
                        PBKDF2SHA256AuthWithSSLTest.class.getName(),
                        environments,
                        environment -> instance(environment.name(), () -> new PBKDF2SHA256AuthWithSSLTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        PBKDF2SHA256AuthWithSSLTest.class,
                                                        PBKDF2SHA256AuthWithSSLTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                PBKDF2SHA256AuthWithSSLTest.class,
                                                                PBKDF2SHA256AuthWithSSLTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                PBKDF2SHA256AuthWithSSLTest.class,
                                                                PBKDF2SHA256AuthWithSSLTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                PBKDF2SHA256AuthWithSSLTest.class,
                                                                PBKDF2SHA256AuthWithSSLTest
                                                                        ::testOpenMetricsTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        PBKDF2SHA256AuthWithSSLTest.class,
                                                        PBKDF2SHA256AuthWithSSLTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(PBKDF2SHA256AuthWithSSLTest.class, javaDockerImage, mode, metrics);
    }
}
