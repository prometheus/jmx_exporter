...
public class SSLWithPKCS12KeyStoreTest2 {
    ...
    public static Action factory() throws Throwable {
        ...
        return Each.parallel(
                        ...
                        environments,
                        environment -> instance(environment.name(), () -> new SSLWithPKCS12KeyStoreTest2(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        SSLWithPKCS12KeyStoreTest2.class,
                                                        SSLWithPKCS12KeyStoreTest2::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                SSLWithPKCS12KeyStoreTest2.class,
                                                                SSLWithPKCS12KeyStoreTest2::testHealthy)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        SSLWithPKCS12KeyStoreTest2.class,
                                                        SSLWithPKCS12KeyStoreTest2::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(SSLWithPKCS12KeyStoreTest2.class, javaDockerImage, mode, metrics);
    }
}
