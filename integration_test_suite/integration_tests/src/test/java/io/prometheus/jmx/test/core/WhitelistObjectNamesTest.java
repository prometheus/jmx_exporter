...
public class WhitelistObjectNamesTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        ...
                        environment -> instance(environment.name(), () -> new WhitelistObjectNamesTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        WhitelistObjectNamesTest.class,
                                                        WhitelistObjectNamesTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                WhitelistObjectNamesTest.class,
                                                                WhitelistObjectNamesTest::testHealthy)))
                                                .child(step(
                                                ...
                                                .child(step(
                                                        ...
                                                        withInstance(
                                                                WhitelistObjectNamesTest.class,
                                                                WhitelistObjectNamesTest
                                                                        ::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        WhitelistObjectNamesTest.class,
                                                        WhitelistObjectNamesTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(WhitelistObjectNamesTest.class, javaDockerImage, mode, metrics);
    }
}
