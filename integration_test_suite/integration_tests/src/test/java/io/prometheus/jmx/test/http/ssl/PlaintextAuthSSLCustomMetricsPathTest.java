...
public class PlaintextAuthSSLCustomMetricsPathTest {
    ...
    public static Action factory() throws Throwable {
        var environments =
                JmxExporterTestEnvironment.createTestEnvironments(PlaintextAuthSSLCustomMetricsPathTest.class).stream()
        ...
        return Each.parallel(
                        PlaintextAuthSSLCustomMetricsPathTest.class.getName(),
                        environments,
                        environment -> instance(
                                        environment.name(),
                                        () -> new PlaintextAuthSSLCustomMetricsPathTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        PlaintextAuthSSLCustomMetricsPathTest.class,
                                                        PlaintextAuthSSLCustomMetricsPathTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                PlaintextAuthSSLCustomMetricsPathTest.class,
                                                                PlaintextAuthSSLCustomMetricsPathTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                PlaintextAuthSSLCustomMetricsPathTest.class,
                                                                PlaintextAuthSSLCustomMetricsPathTest
                                                                        ::testDefaultTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        PlaintextAuthSSLCustomMetricsPathTest.class,
                                                        PlaintextAuthSSLCustomMetricsPathTest::tearDown)))))
                .build();
    }

    private PlaintextAuthSSLCustomMetricsPathTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(PlaintextAuthSSLCustomMetricsPathTest.class, javaDockerImage, mode, metrics);
    }
}
