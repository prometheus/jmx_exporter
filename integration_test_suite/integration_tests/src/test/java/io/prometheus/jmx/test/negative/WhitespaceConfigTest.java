...
public class WhitespaceConfigTest {

    private final JmxExporterTestEnvironment environment;
    private Network network;

    private WhitespaceConfigTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        WhitespaceConfigTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(WhitespaceConfigTest.class),
                        env -> Instance.builder(env.name(), () -> new WhitespaceConfigTest(env))
                                .body(Scope.builder("scenario")
                                        .before(Step.of(
                                                "setUp()",
                                                withInstance(WhitespaceConfigTest.class, WhitespaceConfigTest::setUp)))
                                        .body(Sequence.builder("tests")
                                                .child(Step.of(
                                                        "testHealthy()",
                                                        withInstance(
                                                                WhitespaceConfigTest.class,
                                                                WhitespaceConfigTest::testHealthy)))
                                                .child(Step.of(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                WhitespaceConfigTest.class,
                                                                WhitespaceConfigTest::testDefaultTextMetrics)))
                                                .child(Step.of(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                WhitespaceConfigTest.class,
                                                                WhitespaceConfigTest::testOpenMetricsTextMetrics)))
                                                .child(Step.of(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                WhitespaceConfigTest.class,
                                                                WhitespaceConfigTest::testPrometheusTextMetrics)))
                                                .child(Step.of(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                WhitespaceConfigTest.class,
                                                                WhitespaceConfigTest::testPrometheusProtobufMetrics))))
                                        .after(Step.of(
                                                "tearDown()",
                                                withInstance(
                                                        WhitespaceConfigTest.class, WhitespaceConfigTest::tearDown)))))
                .build();
    }
