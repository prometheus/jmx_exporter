...
public class SHA1AuthWithSSLTest {
    ...
    private SHA1AuthWithSSLTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        var environments = JmxExporterTestEnvironment.createTestEnvironments(SHA1AuthWithSSLTest.class).stream()
        ...
        return Each.parallel(
                        SHA1AuthWithSSLTest.class.getName(),
                        environments,
                        environment -> instance(environment.name(), () -> new SHA1AuthWithSSLTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(SHA1AuthWithSSLTest.class, SHA1AuthWithSSLTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                SHA1AuthWithSSLTest.class,
                                                                SHA1AuthWithSSLTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                SHA1AuthWithSSLTest.class,
                                                                SHA1AuthWithSSLTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                SHA1AuthWithSSLTest.class,
                                                                SHA1AuthWithSSLTest::testOpenMetricsTextMetrics)))
                                                .child(step(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                SHA1AuthWithSSLTest.class,
                                                                SHA1AuthWithSSLTest::testPrometheusTextMetrics)))
                                                .child(step(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                SHA1AuthWithSSLTest.class,
                                                                SHA1AuthWithSSLTest::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        SHA1AuthWithSSLTest.class, SHA1AuthWithSSLTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(SHA1AuthWithSSLTest.class, javaDockerImage, mode, metrics);
    }
}
