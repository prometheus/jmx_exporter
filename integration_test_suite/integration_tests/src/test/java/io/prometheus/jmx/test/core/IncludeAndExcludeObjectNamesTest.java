...
public class IncludeAndExcludeObjectNamesTest {
    ...
    public static Action actionFactory() {
        return Parallel.of(
                IncludeAndExcludeObjectNamesTest.class.getName(),
                JmxExporterTestEnvironment.createEnvironments()
                        .map(IncludeAndExcludeObjectNamesTest::createLifecycleAction)
                        .toList());
    }

    private static Action createLifecycleAction(JmxExporterTestEnvironment jmxExporterTestEnvironment) {
        Action testHealthy = Direct.of("testHealthy", IncludeAndExcludeObjectNamesTest::testHealthy);

        Action testDefaultTextMetrics =
                Direct.of("testDefaultTextMetrics", IncludeAndExcludeObjectNamesTest::testDefaultTextMetrics);

        Action testOpenMetricsTextMetrics =
                Direct.of("testOpenMetricsTextMetrics", IncludeAndExcludeObjectNamesTest::testOpenMetricsTextMetrics);

        Action testPrometheusTextMetrics =
                Direct.of("testPrometheusTextMetrics", IncludeAndExcludeObjectNamesTest::testPrometheusTextMetrics);

        Action testPrometheusProtobufMetrics = Direct.of(
                "testPrometheusProtobufMetrics", IncludeAndExcludeObjectNamesTest::testPrometheusProtobufMetrics);
        ...
        return Lifecycle.of(
                ...
                tests,
                Direct.of("tearDown", IncludeAndExcludeObjectNamesTest::tearDown));
    }

    private static void setUp(Context context, JmxExporterTestEnvironment jmxExporterTestEnvironment) throws Throwable {
        Network network = Network.newNetwork();
        network.getId();
        jmxExporterTestEnvironment.initialize(IncludeAndExcludeObjectNamesTest.class, network);
