...
public class EnvironmentVariableRMISSLTest {
    ...
    public static Action factory() throws Throwable {
        ...
        return Each.parallel(
                        ...
                        environment -> instance(
                                        environment.name(), () -> new EnvironmentVariableRMISSLTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        EnvironmentVariableRMISSLTest.class,
                                                        EnvironmentVariableRMISSLTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                EnvironmentVariableRMISSLTest.class,
                                                                EnvironmentVariableRMISSLTest::testHealthy)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        EnvironmentVariableRMISSLTest.class,
                                                        EnvironmentVariableRMISSLTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(EnvironmentVariableRMISSLTest.class, javaDockerImage, mode, metrics);
    }
}
