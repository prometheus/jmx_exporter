...
public class PlaintextAuthWithThreadsTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        PlaintextAuthWithThreadsTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(PlaintextAuthWithThreadsTest.class),
                        environment -> instance(environment.name(), () -> new PlaintextAuthWithThreadsTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        PlaintextAuthWithThreadsTest.class,
                                                        PlaintextAuthWithThreadsTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                PlaintextAuthWithThreadsTest.class,
                                                                PlaintextAuthWithThreadsTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                PlaintextAuthWithThreadsTest.class,
                                                                PlaintextAuthWithThreadsTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                PlaintextAuthWithThreadsTest.class,
                                                                PlaintextAuthWithThreadsTest
                                                                        ::testOpenMetricsTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        PlaintextAuthWithThreadsTest.class,
                                                        PlaintextAuthWithThreadsTest::tearDown)))))
                .build();
    }

    private PlaintextAuthWithThreadsTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(PlaintextAuthWithThreadsTest.class, javaDockerImage, mode, metrics);
    }
}
