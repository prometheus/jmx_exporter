...
public class SSLWithJKSKeyStoreTest3 {
    ...
    public static Action factory() throws Throwable {
        ...
        return Each.parallel(
                        SSLWithJKSKeyStoreTest3.class.getName(),
                        environments,
                        environment -> instance(environment.name(), () -> new SSLWithJKSKeyStoreTest3(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        SSLWithJKSKeyStoreTest3.class, SSLWithJKSKeyStoreTest3::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                SSLWithJKSKeyStoreTest3.class,
                                                                SSLWithJKSKeyStoreTest3::testHealthy)))
                                                .child(step(
                                                ...
                                                .child(step(
                                                        ...
                                                        withInstance(
                                                                SSLWithJKSKeyStoreTest3.class,
                                                                SSLWithJKSKeyStoreTest3
                                                                        ::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        SSLWithJKSKeyStoreTest3.class,
                                                        SSLWithJKSKeyStoreTest3::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(SSLWithJKSKeyStoreTest3.class, javaDockerImage, mode, metrics);
    }
}
