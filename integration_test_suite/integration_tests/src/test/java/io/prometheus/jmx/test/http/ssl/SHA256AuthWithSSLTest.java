...
public class SHA256AuthWithSSLTest {
    ...
    private SHA256AuthWithSSLTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        var environments = JmxExporterTestEnvironment.createTestEnvironments(SHA256AuthWithSSLTest.class).stream()
        ...
        return Each.parallel(
                        SHA256AuthWithSSLTest.class.getName(),
                        environments,
                        environment -> instance(environment.name(), () -> new SHA256AuthWithSSLTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        SHA256AuthWithSSLTest.class, SHA256AuthWithSSLTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                SHA256AuthWithSSLTest.class,
                                                                SHA256AuthWithSSLTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                SHA256AuthWithSSLTest.class,
                                                                SHA256AuthWithSSLTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                SHA256AuthWithSSLTest.class,
                                                                SHA256AuthWithSSLTest::testOpenMetricsTextMetrics)))
                                                .child(step(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                SHA256AuthWithSSLTest.class,
                                                                SHA256AuthWithSSLTest::testPrometheusTextMetrics)))
                                                .child(step(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                SHA256AuthWithSSLTest.class,
                                                                SHA256AuthWithSSLTest::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        SHA256AuthWithSSLTest.class,
                                                        SHA256AuthWithSSLTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(SHA256AuthWithSSLTest.class, javaDockerImage, mode, metrics);
    }
}
