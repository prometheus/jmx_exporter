...
public class PBKDF2SHA1AuthWithSSLTest {
    ...
    private PBKDF2SHA1AuthWithSSLTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        var environments = JmxExporterTestEnvironment.createTestEnvironments(PBKDF2SHA1AuthWithSSLTest.class).stream()
        ...
        return Each.parallel(
                        PBKDF2SHA1AuthWithSSLTest.class.getName(),
                        environments,
                        environment -> instance(environment.name(), () -> new PBKDF2SHA1AuthWithSSLTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        PBKDF2SHA1AuthWithSSLTest.class,
                                                        PBKDF2SHA1AuthWithSSLTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                PBKDF2SHA1AuthWithSSLTest.class,
                                                                PBKDF2SHA1AuthWithSSLTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                PBKDF2SHA1AuthWithSSLTest.class,
                                                                PBKDF2SHA1AuthWithSSLTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                PBKDF2SHA1AuthWithSSLTest.class,
                                                                PBKDF2SHA1AuthWithSSLTest::testOpenMetricsTextMetrics)))
                                                .child(step(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                PBKDF2SHA1AuthWithSSLTest.class,
                                                                PBKDF2SHA1AuthWithSSLTest::testPrometheusTextMetrics)))
                                                .child(step(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                PBKDF2SHA1AuthWithSSLTest.class,
                                                                PBKDF2SHA1AuthWithSSLTest
                                                                        ::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        PBKDF2SHA1AuthWithSSLTest.class,
                                                        PBKDF2SHA1AuthWithSSLTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(PBKDF2SHA1AuthWithSSLTest.class, javaDockerImage, mode, metrics);
    }
}
