...
public class BlacklistObjectNamesTest extends AbstractTest implements Consumer<HttpResponse> {
    ...
    public void assertProtobufFormatResponse(HttpResponse httpResponse) {
