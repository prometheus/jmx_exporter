...
public class Interval5Test {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        Interval5Test.class.getName(),
                        OpenTelemetryTestEnvironment.createTestEnvironments(Interval5Test.class),
                        environment -> instance(environment.name(), () -> new Interval5Test(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()", withInstance(Interval5Test.class, Interval5Test::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(Interval5Test.class, Interval5Test::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                Interval5Test.class,
                                                                Interval5Test::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                Interval5Test.class,
                                                                Interval5Test::testOpenMetricsTextMetrics)))
                                                .child(step(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                Interval5Test.class,
                                                                Interval5Test::testPrometheusTextMetrics)))
                                                .child(step(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                Interval5Test.class,
                                                                Interval5Test::testPrometheusProtobufMetrics)))
                                                .child(step(
                                                        "testPrometheusHasMetrics()",
                                                        withInstance(
                                                                Interval5Test.class,
                                                                Interval5Test::testPrometheusHasMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(Interval5Test.class, Interval5Test::tearDown)))))
                .build();
    }
    ...
    public void testPrometheusHasMetrics() throws Throwable {
        ...
        Set<String> metricNames = loadMetricNames(Interval5Test.class, mode, javaDockerImage);
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(Interval5Test.class, javaDockerImage, mode, metrics);
    }
}
