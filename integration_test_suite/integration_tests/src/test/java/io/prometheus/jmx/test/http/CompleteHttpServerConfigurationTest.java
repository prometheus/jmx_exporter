    ...
    public static Action actionFactory() {
        return Parallel.of(
                ...
                JmxExporterTestEnvironment.createEnvironments()
                        ...
                        .map(CompleteHttpServerConfigurationTest::createLifecycleAction)
                        .toList());
    }

    private static Action createLifecycleAction(JmxExporterTestEnvironment environment) {
        Action testHealthy = Direct.of("testHealthy", CompleteHttpServerConfigurationTest::testHealthy);

        Action testDefaultTextMetrics =
                Direct.of("testDefaultTextMetrics", CompleteHttpServerConfigurationTest::testDefaultTextMetrics);

        Action testOpenMetricsTextMetrics = Direct.of(
                "testOpenMetricsTextMetrics", CompleteHttpServerConfigurationTest::testOpenMetricsTextMetrics);

        Action testPrometheusTextMetrics =
                Direct.of("testPrometheusTextMetrics", CompleteHttpServerConfigurationTest::testPrometheusTextMetrics);

        Action testPrometheusProtobufMetrics = Direct.of(
                "testPrometheusProtobufMetrics", CompleteHttpServerConfigurationTest::testPrometheusProtobufMetrics);
        ...
        return Lifecycle.of(
                ...
                tests,
                Direct.of("tearDown", CompleteHttpServerConfigurationTest::tearDown));
    }

    private static void setUp(Context context, JmxExporterTestEnvironment environment) throws Throwable {
        Network network = Network.newNetwork();
        network.getId();
        environment.initialize(CompleteHttpServerConfigurationTest.class, network);
