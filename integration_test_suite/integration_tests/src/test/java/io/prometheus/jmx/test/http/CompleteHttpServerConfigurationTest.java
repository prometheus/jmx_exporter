...
public class CompleteHttpServerConfigurationTest {
    ...
    private CompleteHttpServerConfigurationTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        ...
        return Each.parallel(
                        ...
                        environment -> instance(
                                        environment.name(), () -> new CompleteHttpServerConfigurationTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(CompleteHttpServerConfigurationTest.class, javaDockerImage, mode, metrics);
    }
}
