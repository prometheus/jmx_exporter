...
public class RMISSLWithCustomProtocolsTest {

    private final JmxExporterTestEnvironment environment;
    private Network network;

    private RMISSLWithCustomProtocolsTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        var environments =
                JmxExporterTestEnvironment.createTestEnvironments(RMISSLWithCustomProtocolsTest.class).stream()
        ...
        return Each.parallel(
                        RMISSLWithCustomProtocolsTest.class.getName(),
                        environments,
                        environment -> instance(
                                        environment.name(), () -> new RMISSLWithCustomProtocolsTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        RMISSLWithCustomProtocolsTest.class,
                                                        RMISSLWithCustomProtocolsTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                RMISSLWithCustomProtocolsTest.class,
                                                                RMISSLWithCustomProtocolsTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                RMISSLWithCustomProtocolsTest.class,
                                                                RMISSLWithCustomProtocolsTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                RMISSLWithCustomProtocolsTest.class,
                                                                RMISSLWithCustomProtocolsTest
                                                                        ::testOpenMetricsTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        RMISSLWithCustomProtocolsTest.class,
                                                        RMISSLWithCustomProtocolsTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(RMISSLWithCustomProtocolsTest.class, javaDockerImage, mode, metrics);
    }
}
