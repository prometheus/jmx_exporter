...
public class EmptyConfigTest {
    ...
    private EmptyConfigTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        EmptyConfigTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(EmptyConfigTest.class),
                        env -> Instance.builder(env.name(), () -> new EmptyConfigTest(env))
                                .body(Scope.builder("scenario")
                                        .before(Step.of(
                                                "setUp()", withInstance(EmptyConfigTest.class, EmptyConfigTest::setUp)))
                                        .body(Sequence.builder("tests")
                                                .child(Step.of(
                                                        "testHealthy()",
                                                        withInstance(
                                                                EmptyConfigTest.class, EmptyConfigTest::testHealthy)))
                                                .child(Step.of(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                EmptyConfigTest.class,
                                                                EmptyConfigTest::testDefaultTextMetrics)))
                                                .child(Step.of(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                EmptyConfigTest.class,
                                                                EmptyConfigTest::testOpenMetricsTextMetrics)))
                                                .child(Step.of(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                EmptyConfigTest.class,
                                                                EmptyConfigTest::testPrometheusTextMetrics)))
                                                .child(Step.of(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                EmptyConfigTest.class,
                                                                EmptyConfigTest::testPrometheusProtobufMetrics))))
                                        .after(Step.of(
                                                "tearDown()",
                                                withInstance(EmptyConfigTest.class, EmptyConfigTest::tearDown)))))
                .build();
    }
