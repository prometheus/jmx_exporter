...
public class MetricCustomizersExtraMetricsTest {
    ...
    public static Action actionFactory() {
        return Parallel.of(
                MetricCustomizersExtraMetricsTest.class.getName(),
                JmxExporterTestEnvironment.createEnvironments()
                        .map(MetricCustomizersExtraMetricsTest::createLifecycleAction)
                        .toList());
    }

    private static Action createLifecycleAction(JmxExporterTestEnvironment jmxExporterTestEnvironment) {
        Action testHealthy = Direct.of("testHealthy", MetricCustomizersExtraMetricsTest::testHealthy);

        Action testDefaultTextMetrics =
                Direct.of("testDefaultTextMetrics", MetricCustomizersExtraMetricsTest::testDefaultTextMetrics);

        Action testOpenMetricsTextMetrics =
                Direct.of("testOpenMetricsTextMetrics", MetricCustomizersExtraMetricsTest::testOpenMetricsTextMetrics);

        Action testPrometheusTextMetrics =
                Direct.of("testPrometheusTextMetrics", MetricCustomizersExtraMetricsTest::testPrometheusTextMetrics);

        Action testPrometheusProtobufMetrics = Direct.of(
                "testPrometheusProtobufMetrics", MetricCustomizersExtraMetricsTest::testPrometheusProtobufMetrics);
        ...
        return Lifecycle.of(
                ...
                tests,
                Direct.of("tearDown", MetricCustomizersExtraMetricsTest::tearDown));
    }

    private static void setUp(Context context, JmxExporterTestEnvironment jmxExporterTestEnvironment) throws Throwable {
        Network network = Network.newNetwork();
        network.getId();
        jmxExporterTestEnvironment.initialize(MetricCustomizersExtraMetricsTest.class, network);
