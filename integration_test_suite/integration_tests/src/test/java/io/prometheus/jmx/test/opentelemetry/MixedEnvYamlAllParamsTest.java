...
public class MixedEnvYamlAllParamsTest {

    private final OpenTelemetryTestEnvironment environment;
    private PrometheusQueryHelper prometheusQueryHelper;
    private Network network;

    private MixedEnvYamlAllParamsTest(OpenTelemetryTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        MixedEnvYamlAllParamsTest.class.getName(),
                        OpenTelemetryTestEnvironment.createTestEnvironments(MixedEnvYamlAllParamsTest.class),
                        environment -> instance(
                                        environment.exporterTestEnvironment().name(),
                                        () -> new MixedEnvYamlAllParamsTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        MixedEnvYamlAllParamsTest.class,
                                                        MixedEnvYamlAllParamsTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                MixedEnvYamlAllParamsTest.class,
                                                                MixedEnvYamlAllParamsTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                MixedEnvYamlAllParamsTest.class,
                                                                MixedEnvYamlAllParamsTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                MixedEnvYamlAllParamsTest.class,
                                                                MixedEnvYamlAllParamsTest::testOpenMetricsTextMetrics)))
                                                .child(step(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                MixedEnvYamlAllParamsTest.class,
                                                                MixedEnvYamlAllParamsTest::testPrometheusTextMetrics)))
                                                .child(step(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                MixedEnvYamlAllParamsTest.class,
                                                                MixedEnvYamlAllParamsTest
                                                                        ::testPrometheusProtobufMetrics)))
                                                .child(step(
                                                        "testPrometheusHasMetrics()",
                                                        withInstance(
                                                                MixedEnvYamlAllParamsTest.class,
                                                                MixedEnvYamlAllParamsTest::testPrometheusHasMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        MixedEnvYamlAllParamsTest.class,
                                                        MixedEnvYamlAllParamsTest::tearDown)))))
                .build();
    }
    ...
    public void testPrometheusHasMetrics() throws Throwable {
        ...
        Set<String> metricNames = loadMetricNames(MixedEnvYamlAllParamsTest.class, mode, javaDockerImage);
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(MixedEnvYamlAllParamsTest.class, javaDockerImage, mode, metrics);
    }
}
