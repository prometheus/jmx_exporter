    ...
    public static Action actionFactory() {
        return Parallel.of(
                ...
                JmxExporterTestEnvironment.createEnvironments()
                        ...
                        .map(SSLAndBasicAuthenticationPBKDF2WithHmacSHA512Test::createLifecycleAction)
                        .toList());
    }

    private static Action createLifecycleAction(JmxExporterTestEnvironment environment) {
        Action testHealthy = Direct.of("testHealthy", SSLAndBasicAuthenticationPBKDF2WithHmacSHA512Test::testHealthy);

        Action testDefaultTextMetrics = Direct.of(
                "testDefaultTextMetrics", SSLAndBasicAuthenticationPBKDF2WithHmacSHA512Test::testDefaultTextMetrics);
        ...
        return Lifecycle.of(
                ...
                tests,
                Direct.of("tearDown", SSLAndBasicAuthenticationPBKDF2WithHmacSHA512Test::tearDown));
    }

    private static void setUp(Context context, JmxExporterTestEnvironment environment) throws Throwable {
        Network network = Network.newNetwork();
        network.getId();
        environment.initialize(SSLAndBasicAuthenticationPBKDF2WithHmacSHA512Test.class, network);
