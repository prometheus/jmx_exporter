...
public class PBKDF2AuthSSLCustomMetricsPathTest {
    ...
    public static Action factory() throws Throwable {
        var environments =
                JmxExporterTestEnvironment.createTestEnvironments(PBKDF2AuthSSLCustomMetricsPathTest.class).stream()
        ...
        return Each.parallel(
                        PBKDF2AuthSSLCustomMetricsPathTest.class.getName(),
                        environments,
                        environment -> instance(
                                        environment.name(), () -> new PBKDF2AuthSSLCustomMetricsPathTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        PBKDF2AuthSSLCustomMetricsPathTest.class,
                                                        PBKDF2AuthSSLCustomMetricsPathTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                PBKDF2AuthSSLCustomMetricsPathTest.class,
                                                                PBKDF2AuthSSLCustomMetricsPathTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                PBKDF2AuthSSLCustomMetricsPathTest.class,
                                                                PBKDF2AuthSSLCustomMetricsPathTest
                                                                        ::testDefaultTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        PBKDF2AuthSSLCustomMetricsPathTest.class,
                                                        PBKDF2AuthSSLCustomMetricsPathTest::tearDown)))))
                .build();
    }

    private PBKDF2AuthSSLCustomMetricsPathTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(PBKDF2AuthSSLCustomMetricsPathTest.class, javaDockerImage, mode, metrics);
    }
}
