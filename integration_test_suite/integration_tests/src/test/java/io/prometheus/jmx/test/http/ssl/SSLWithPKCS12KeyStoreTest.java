...
public class SSLWithPKCS12KeyStoreTest {
    ...
    public static Action factory() throws Throwable {
        ...
        return Each.parallel(
                        ...
                        environments,
                        environment -> instance(environment.name(), () -> new SSLWithPKCS12KeyStoreTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        SSLWithPKCS12KeyStoreTest.class,
                                                        SSLWithPKCS12KeyStoreTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                SSLWithPKCS12KeyStoreTest.class,
                                                                SSLWithPKCS12KeyStoreTest::testHealthy)))
                                                .child(step(
                                                ...
                                                .child(step(
                                                        ...
                                                        withInstance(
                                                                SSLWithPKCS12KeyStoreTest.class,
                                                                SSLWithPKCS12KeyStoreTest
                                                                        ::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        SSLWithPKCS12KeyStoreTest.class,
                                                        SSLWithPKCS12KeyStoreTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(SSLWithPKCS12KeyStoreTest.class, javaDockerImage, mode, metrics);
    }
}
