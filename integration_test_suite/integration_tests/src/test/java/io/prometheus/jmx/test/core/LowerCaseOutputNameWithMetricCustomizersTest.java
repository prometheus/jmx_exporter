...
public class LowerCaseOutputNameWithMetricCustomizersTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        LowerCaseOutputNameWithMetricCustomizersTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(
                                LowerCaseOutputNameWithMetricCustomizersTest.class),
                        environment -> instance(
                                        environment.name(),
                                        () -> new LowerCaseOutputNameWithMetricCustomizersTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        LowerCaseOutputNameWithMetricCustomizersTest.class,
                                                        LowerCaseOutputNameWithMetricCustomizersTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                LowerCaseOutputNameWithMetricCustomizersTest.class,
                                                                LowerCaseOutputNameWithMetricCustomizersTest
                                                                        ::testHealthy)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        LowerCaseOutputNameWithMetricCustomizersTest.class,
                                                        LowerCaseOutputNameWithMetricCustomizersTest::tearDown)))))
                .build();
    }

    private LowerCaseOutputNameWithMetricCustomizersTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(LowerCaseOutputNameWithMetricCustomizersTest.class, javaDockerImage, mode, metrics);
    }
}
