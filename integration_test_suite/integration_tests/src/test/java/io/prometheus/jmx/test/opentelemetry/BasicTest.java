...
public class BasicTest {
    ...
    private BasicTest(OpenTelemetryTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        ...
                        environment -> instance(environment.name(), () -> new BasicTest(environment))
                                .body(scope("scenario")
                                        .before(step("setUp()", withInstance(BasicTest.class, BasicTest::setUp)))
                                        ...
                                        .after(step("tearDown()", withInstance(BasicTest.class, BasicTest::tearDown)))))
                .build();
    }
    ...
    public void testPrometheusHasMetrics() throws Throwable {
        ...
        Set<String> metricNames = loadMetricNames(BasicTest.class, mode, javaDockerImage);
