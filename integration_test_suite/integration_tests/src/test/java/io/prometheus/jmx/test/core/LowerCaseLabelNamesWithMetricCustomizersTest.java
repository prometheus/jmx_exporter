...
public class LowerCaseLabelNamesWithMetricCustomizersTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        LowerCaseLabelNamesWithMetricCustomizersTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(
                                LowerCaseLabelNamesWithMetricCustomizersTest.class),
                        environment -> instance(
                                        environment.name(),
                                        () -> new LowerCaseLabelNamesWithMetricCustomizersTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        LowerCaseLabelNamesWithMetricCustomizersTest.class,
                                                        LowerCaseLabelNamesWithMetricCustomizersTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                LowerCaseLabelNamesWithMetricCustomizersTest.class,
                                                                LowerCaseLabelNamesWithMetricCustomizersTest
                                                                        ::testHealthy)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        LowerCaseLabelNamesWithMetricCustomizersTest.class,
                                                        LowerCaseLabelNamesWithMetricCustomizersTest::tearDown)))))
                .build();
    }

    private LowerCaseLabelNamesWithMetricCustomizersTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(LowerCaseLabelNamesWithMetricCustomizersTest.class, javaDockerImage, mode, metrics);
    }
}
