...
public class SHA512AuthWithSSLTest {
    ...
    private SHA512AuthWithSSLTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        var environments = JmxExporterTestEnvironment.createTestEnvironments(SHA512AuthWithSSLTest.class).stream()
        ...
        return Each.parallel(
                        SHA512AuthWithSSLTest.class.getName(),
                        environments,
                        environment -> instance(environment.name(), () -> new SHA512AuthWithSSLTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        SHA512AuthWithSSLTest.class, SHA512AuthWithSSLTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                SHA512AuthWithSSLTest.class,
                                                                SHA512AuthWithSSLTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                SHA512AuthWithSSLTest.class,
                                                                SHA512AuthWithSSLTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                SHA512AuthWithSSLTest.class,
                                                                SHA512AuthWithSSLTest::testOpenMetricsTextMetrics)))
                                                .child(step(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                SHA512AuthWithSSLTest.class,
                                                                SHA512AuthWithSSLTest::testPrometheusTextMetrics)))
                                                .child(step(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                SHA512AuthWithSSLTest.class,
                                                                SHA512AuthWithSSLTest::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        SHA512AuthWithSSLTest.class,
                                                        SHA512AuthWithSSLTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(SHA512AuthWithSSLTest.class, javaDockerImage, mode, metrics);
    }
}
