...
public class MixedConfigurationTest {
    ...
    private MixedConfigurationTest(OpenTelemetryTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        ...
                        OpenTelemetryTestEnvironment.createTestEnvironments(MixedConfigurationTest.class),
                        environment -> instance(
                                        environment.exporterTestEnvironment().name(),
                                        () -> new MixedConfigurationTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        MixedConfigurationTest.class, MixedConfigurationTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                MixedConfigurationTest.class,
                                                                MixedConfigurationTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                MixedConfigurationTest.class,
                                                                MixedConfigurationTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                MixedConfigurationTest.class,
                                                                MixedConfigurationTest::testOpenMetricsTextMetrics)))
                                                .child(step(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                MixedConfigurationTest.class,
                                                                MixedConfigurationTest::testPrometheusTextMetrics)))
                                                .child(step(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                MixedConfigurationTest.class,
                                                                MixedConfigurationTest::testPrometheusProtobufMetrics)))
                                                .child(step(
                                                        "testPrometheusHasMetrics()",
                                                        withInstance(
                                                                MixedConfigurationTest.class,
                                                                MixedConfigurationTest::testPrometheusHasMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        MixedConfigurationTest.class,
                                                        MixedConfigurationTest::tearDown)))))
                .build();
    }
    ...
    public void testPrometheusHasMetrics() throws Throwable {
        ...
        Set<String> metricNames = loadMetricNames(MixedConfigurationTest.class, mode, javaDockerImage);
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(MixedConfigurationTest.class, javaDockerImage, mode, metrics);
    }
}
