...
public class RMISSLWithCustomCiphersTest {

    private final JmxExporterTestEnvironment environment;
    private Network network;

    private RMISSLWithCustomCiphersTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        var environments = JmxExporterTestEnvironment.createTestEnvironments(RMISSLWithCustomCiphersTest.class).stream()
        ...
        return Each.parallel(
                        RMISSLWithCustomCiphersTest.class.getName(),
                        environments,
                        environment -> instance(environment.name(), () -> new RMISSLWithCustomCiphersTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        RMISSLWithCustomCiphersTest.class,
                                                        RMISSLWithCustomCiphersTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                RMISSLWithCustomCiphersTest.class,
                                                                RMISSLWithCustomCiphersTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                RMISSLWithCustomCiphersTest.class,
                                                                RMISSLWithCustomCiphersTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                RMISSLWithCustomCiphersTest.class,
                                                                RMISSLWithCustomCiphersTest
                                                                        ::testOpenMetricsTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        RMISSLWithCustomCiphersTest.class,
                                                        RMISSLWithCustomCiphersTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(RMISSLWithCustomCiphersTest.class, javaDockerImage, mode, metrics);
    }
}
