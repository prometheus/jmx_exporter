...
public class AllLowercasePlusExcludeObjectNamesTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        AllLowercasePlusExcludeObjectNamesTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(AllLowercasePlusExcludeObjectNamesTest.class),
                        environment -> instance(
                                        environment.name(),
                                        () -> new AllLowercasePlusExcludeObjectNamesTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        AllLowercasePlusExcludeObjectNamesTest.class,
                                                        AllLowercasePlusExcludeObjectNamesTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                AllLowercasePlusExcludeObjectNamesTest.class,
                                                                AllLowercasePlusExcludeObjectNamesTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                AllLowercasePlusExcludeObjectNamesTest.class,
                                                                AllLowercasePlusExcludeObjectNamesTest
                                                                        ::testDefaultTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        AllLowercasePlusExcludeObjectNamesTest.class,
                                                        AllLowercasePlusExcludeObjectNamesTest::tearDown)))))
                .build();
    }

    private AllLowercasePlusExcludeObjectNamesTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(AllLowercasePlusExcludeObjectNamesTest.class, javaDockerImage, mode, metrics);
    }
}
