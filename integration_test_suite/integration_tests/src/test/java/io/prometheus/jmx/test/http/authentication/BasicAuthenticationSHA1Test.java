...
public class BasicAuthenticationSHA1Test {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        ...
                        environment -> instance(environment.name(), () -> new BasicAuthenticationSHA1Test(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        BasicAuthenticationSHA1Test.class,
                                                        BasicAuthenticationSHA1Test::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                BasicAuthenticationSHA1Test.class,
                                                                BasicAuthenticationSHA1Test::testHealthy)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        BasicAuthenticationSHA1Test.class,
                                                        BasicAuthenticationSHA1Test::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(BasicAuthenticationSHA1Test.class, javaDockerImage, mode, metrics);
    }
}
