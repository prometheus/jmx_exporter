...
public class PlaintextAuthWithCustomMetricsPathTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        PlaintextAuthWithCustomMetricsPathTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(PlaintextAuthWithCustomMetricsPathTest.class),
                        environment -> instance(
                                        environment.name(),
                                        () -> new PlaintextAuthWithCustomMetricsPathTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        PlaintextAuthWithCustomMetricsPathTest.class,
                                                        PlaintextAuthWithCustomMetricsPathTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                PlaintextAuthWithCustomMetricsPathTest.class,
                                                                PlaintextAuthWithCustomMetricsPathTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                PlaintextAuthWithCustomMetricsPathTest.class,
                                                                PlaintextAuthWithCustomMetricsPathTest
                                                                        ::testDefaultTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        PlaintextAuthWithCustomMetricsPathTest.class,
                                                        PlaintextAuthWithCustomMetricsPathTest::tearDown)))))
                .build();
    }

    private PlaintextAuthWithCustomMetricsPathTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(PlaintextAuthWithCustomMetricsPathTest.class, javaDockerImage, mode, metrics);
    }
}
