...
public class SSLWithPKCS12KeyStoreTest3 {
    ...
    public static Action factory() throws Throwable {
        ...
        return Each.parallel(
                        ...
                        environments,
                        environment -> instance(environment.name(), () -> new SSLWithPKCS12KeyStoreTest3(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        SSLWithPKCS12KeyStoreTest3.class,
                                                        SSLWithPKCS12KeyStoreTest3::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                SSLWithPKCS12KeyStoreTest3.class,
                                                                SSLWithPKCS12KeyStoreTest3::testHealthy)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        SSLWithPKCS12KeyStoreTest3.class,
                                                        SSLWithPKCS12KeyStoreTest3::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(SSLWithPKCS12KeyStoreTest3.class, javaDockerImage, mode, metrics);
    }
}
