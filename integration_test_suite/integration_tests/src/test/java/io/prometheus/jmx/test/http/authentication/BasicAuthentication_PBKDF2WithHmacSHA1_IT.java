...
public class BasicAuthentication_PBKDF2WithHmacSHA1_IT extends Abstract_IT implements ContentConsumer {
    ...
    protected static Stream<Parameter> parameters() {
        // Filter specific Docker images that don't support PBKDF2WithHmacSHA1
