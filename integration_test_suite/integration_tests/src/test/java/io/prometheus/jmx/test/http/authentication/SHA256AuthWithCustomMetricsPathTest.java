...
public class SHA256AuthWithCustomMetricsPathTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        SHA256AuthWithCustomMetricsPathTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(SHA256AuthWithCustomMetricsPathTest.class),
                        environment -> instance(
                                        environment.name(), () -> new SHA256AuthWithCustomMetricsPathTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        SHA256AuthWithCustomMetricsPathTest.class,
                                                        SHA256AuthWithCustomMetricsPathTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                SHA256AuthWithCustomMetricsPathTest.class,
                                                                SHA256AuthWithCustomMetricsPathTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                SHA256AuthWithCustomMetricsPathTest.class,
                                                                SHA256AuthWithCustomMetricsPathTest
                                                                        ::testDefaultTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        SHA256AuthWithCustomMetricsPathTest.class,
                                                        SHA256AuthWithCustomMetricsPathTest::tearDown)))))
                .build();
    }

    private SHA256AuthWithCustomMetricsPathTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(SHA256AuthWithCustomMetricsPathTest.class, javaDockerImage, mode, metrics);
    }
}
