...
public class PlaintextAuthWithSSLTest {
    ...
    private PlaintextAuthWithSSLTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        var environments = JmxExporterTestEnvironment.createTestEnvironments(PlaintextAuthWithSSLTest.class).stream()
        ...
        return Each.parallel(
                        PlaintextAuthWithSSLTest.class.getName(),
                        environments,
                        environment -> instance(environment.name(), () -> new PlaintextAuthWithSSLTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        PlaintextAuthWithSSLTest.class,
                                                        PlaintextAuthWithSSLTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                PlaintextAuthWithSSLTest.class,
                                                                PlaintextAuthWithSSLTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                PlaintextAuthWithSSLTest.class,
                                                                PlaintextAuthWithSSLTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                PlaintextAuthWithSSLTest.class,
                                                                PlaintextAuthWithSSLTest::testOpenMetricsTextMetrics)))
                                                .child(step(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                PlaintextAuthWithSSLTest.class,
                                                                PlaintextAuthWithSSLTest::testPrometheusTextMetrics)))
                                                .child(step(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                PlaintextAuthWithSSLTest.class,
                                                                PlaintextAuthWithSSLTest
                                                                        ::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        PlaintextAuthWithSSLTest.class,
                                                        PlaintextAuthWithSSLTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(PlaintextAuthWithSSLTest.class, javaDockerImage, mode, metrics);
    }
}
