...
public class ValueFactorWithLabelsTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        ValueFactorWithLabelsTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(ValueFactorWithLabelsTest.class),
                        environment -> instance(environment.name(), () -> new ValueFactorWithLabelsTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        ValueFactorWithLabelsTest.class,
                                                        ValueFactorWithLabelsTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                ValueFactorWithLabelsTest.class,
                                                                ValueFactorWithLabelsTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                ValueFactorWithLabelsTest.class,
                                                                ValueFactorWithLabelsTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                ValueFactorWithLabelsTest.class,
                                                                ValueFactorWithLabelsTest::testOpenMetricsTextMetrics)))
                                                .child(step(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                ValueFactorWithLabelsTest.class,
                                                                ValueFactorWithLabelsTest::testPrometheusTextMetrics)))
                                                .child(step(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                ValueFactorWithLabelsTest.class,
                                                                ValueFactorWithLabelsTest
                                                                        ::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        ValueFactorWithLabelsTest.class,
                                                        ValueFactorWithLabelsTest::tearDown)))))
                .build();
    }

    private ValueFactorWithLabelsTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(ValueFactorWithLabelsTest.class, javaDockerImage, mode, metrics);
    }
}
