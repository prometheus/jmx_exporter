...
public class RMISSLFromYamlTest {
    ...
    private RMISSLFromYamlTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        ...
        return Each.parallel(
                        ...
                        environments,
                        environment -> instance(environment.name(), () -> new RMISSLFromYamlTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(RMISSLFromYamlTest.class, javaDockerImage, mode, metrics);
    }
}
