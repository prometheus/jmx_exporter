...
public class RMISSLFromYamlTest {
    ...
    private static Action createLifecycleAction(JmxExporterTestEnvironment jmxExporterTestEnvironment) {
        Action testHealthy = Direct.of("testHealthy", RMISSLFromYamlTest::testHealthy);

        Action testDefaultTextMetrics = Direct.of("testDefaultTextMetrics", RMISSLFromYamlTest::testDefaultTextMetrics);

        Action testOpenMetricsTextMetrics =
                Direct.of("testOpenMetricsTextMetrics", RMISSLFromYamlTest::testOpenMetricsTextMetrics);

        Action testPrometheusTextMetrics =
                Direct.of("testPrometheusTextMetrics", RMISSLFromYamlTest::testPrometheusTextMetrics);

        Action testPrometheusProtobufMetrics =
                Direct.of("testPrometheusProtobufMetrics", RMISSLFromYamlTest::testPrometheusProtobufMetrics);
        ...
        return Lifecycle.of(
                ...
                tests,
                Direct.of("tearDown", RMISSLFromYamlTest::tearDown));
    }
