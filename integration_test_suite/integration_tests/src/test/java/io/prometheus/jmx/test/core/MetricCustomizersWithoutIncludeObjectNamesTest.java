...
public class MetricCustomizersWithoutIncludeObjectNamesTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        MetricCustomizersWithoutIncludeObjectNamesTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(
                                MetricCustomizersWithoutIncludeObjectNamesTest.class),
                        environment -> instance(
                                        environment.name(),
                                        () -> new MetricCustomizersWithoutIncludeObjectNamesTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        MetricCustomizersWithoutIncludeObjectNamesTest.class,
                                                        MetricCustomizersWithoutIncludeObjectNamesTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                MetricCustomizersWithoutIncludeObjectNamesTest.class,
                                                                MetricCustomizersWithoutIncludeObjectNamesTest
                                                                        ::testHealthy)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        MetricCustomizersWithoutIncludeObjectNamesTest.class,
                                                        MetricCustomizersWithoutIncludeObjectNamesTest::tearDown)))))
                .build();
    }

    private MetricCustomizersWithoutIncludeObjectNamesTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(MetricCustomizersWithoutIncludeObjectNamesTest.class, javaDockerImage, mode, metrics);
    }
}
