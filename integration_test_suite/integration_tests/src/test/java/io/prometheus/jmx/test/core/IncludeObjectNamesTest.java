...
public class IncludeObjectNamesTest {
    ...
    public static Spec<?> factory() throws Throwable {
        return Parallel.of(IncludeObjectNamesTest.class.getName())
                .each(
                        JmxExporterTestEnvironment.createTestEnvironments(IncludeObjectNamesTest.class),
                        environment -> Instance.of(environment.name(), () -> new IncludeObjectNamesTest(environment))
                                .child(Lifecycle.<IncludeObjectNamesTest>of("lifecycle")
                                        .before("setUp()", IncludeObjectNamesTest::setUp)
                                        .child("testHealthy()", IncludeObjectNamesTest::testHealthy)
                                        .child(
                                                "testDefaultTextMetrics()",
                                                IncludeObjectNamesTest::testDefaultTextMetrics)
                                        .child(
                                                "testOpenMetricsTextMetrics()",
                                                IncludeObjectNamesTest::testOpenMetricsTextMetrics)
                                        .child(
                                                "testPrometheusTextMetrics()",
                                                IncludeObjectNamesTest::testPrometheusTextMetrics)
                                        .child(
                                                "testPrometheusProtobufMetrics()",
                                                IncludeObjectNamesTest::testPrometheusProtobufMetrics)
                                        .after("tearDown()", IncludeObjectNamesTest::tearDown)));
    }

    private IncludeObjectNamesTest(JmxExporterTestEnvironment environment) {
