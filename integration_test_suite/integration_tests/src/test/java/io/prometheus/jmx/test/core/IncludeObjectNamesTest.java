...
public class IncludeObjectNamesTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        IncludeObjectNamesTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(IncludeObjectNamesTest.class),
                        environment -> instance(environment.name(), () -> new IncludeObjectNamesTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        IncludeObjectNamesTest.class, IncludeObjectNamesTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                IncludeObjectNamesTest.class,
                                                                IncludeObjectNamesTest::testHealthy)))
                                                .child(step(
                                                ...
                                                .child(step(
                                                        ...
                                                        withInstance(
                                                                IncludeObjectNamesTest.class,
                                                                IncludeObjectNamesTest
                                                                        ::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        IncludeObjectNamesTest.class,
                                                        IncludeObjectNamesTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(IncludeObjectNamesTest.class, javaDockerImage, mode, metrics);
    }
}
