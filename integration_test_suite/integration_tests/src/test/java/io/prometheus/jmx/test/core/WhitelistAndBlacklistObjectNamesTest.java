...
public class WhitelistAndBlacklistObjectNamesTest {
    ...
    private static Action createLifecycleAction(JmxExporterTestEnvironment jmxExporterTestEnvironment) {
        Action testHealthy = Direct.of("testHealthy", WhitelistAndBlacklistObjectNamesTest::testHealthy);

        Action testDefaultTextMetrics =
                Direct.of("testDefaultTextMetrics", WhitelistAndBlacklistObjectNamesTest::testDefaultTextMetrics);

        Action testOpenMetricsTextMetrics = Direct.of(
                "testOpenMetricsTextMetrics", WhitelistAndBlacklistObjectNamesTest::testOpenMetricsTextMetrics);

        Action testPrometheusTextMetrics =
                Direct.of("testPrometheusTextMetrics", WhitelistAndBlacklistObjectNamesTest::testPrometheusTextMetrics);

        Action testPrometheusProtobufMetrics = Direct.of(
                "testPrometheusProtobufMetrics", WhitelistAndBlacklistObjectNamesTest::testPrometheusProtobufMetrics);
        ...
        return Lifecycle.of(
                ...
                tests,
                Direct.of("tearDown", WhitelistAndBlacklistObjectNamesTest::tearDown));
    }
