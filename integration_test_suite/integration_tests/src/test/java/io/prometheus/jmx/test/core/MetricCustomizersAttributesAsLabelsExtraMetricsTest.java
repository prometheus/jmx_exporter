...
public class MetricCustomizersAttributesAsLabelsExtraMetricsTest {
    ...
    public static Action actionFactory() {
        return Parallel.of(
                MetricCustomizersAttributesAsLabelsExtraMetricsTest.class.getName(),
                JmxExporterTestEnvironment.createEnvironments()
                        .map(MetricCustomizersAttributesAsLabelsExtraMetricsTest::createLifecycleAction)
                        .toList());
    }

    private static Action createLifecycleAction(JmxExporterTestEnvironment jmxExporterTestEnvironment) {
        Action testHealthy = Direct.of("testHealthy", MetricCustomizersAttributesAsLabelsExtraMetricsTest::testHealthy);

        Action testDefaultTextMetrics = Direct.of(
                "testDefaultTextMetrics", MetricCustomizersAttributesAsLabelsExtraMetricsTest::testDefaultTextMetrics);

        Action testOpenMetricsTextMetrics = Direct.of(
                "testOpenMetricsTextMetrics",
                MetricCustomizersAttributesAsLabelsExtraMetricsTest::testOpenMetricsTextMetrics);

        Action testPrometheusTextMetrics = Direct.of(
                "testPrometheusTextMetrics",
                MetricCustomizersAttributesAsLabelsExtraMetricsTest::testPrometheusTextMetrics);

        Action testPrometheusProtobufMetrics = Direct.of(
                "testPrometheusProtobufMetrics",
                MetricCustomizersAttributesAsLabelsExtraMetricsTest::testPrometheusProtobufMetrics);
        ...
        return Lifecycle.of(
                ...
                tests,
                Direct.of("tearDown", MetricCustomizersAttributesAsLabelsExtraMetricsTest::tearDown));
    }

    private static void setUp(Context context, JmxExporterTestEnvironment jmxExporterTestEnvironment) throws Throwable {
        Network network = Network.newNetwork();
        network.getId();
        jmxExporterTestEnvironment.initialize(MetricCustomizersAttributesAsLabelsExtraMetricsTest.class, network);
