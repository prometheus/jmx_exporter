...
public class AuthenticatorPluginWithSSLTest {
    ...
    private AuthenticatorPluginWithSSLTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        var environments =
                JmxExporterTestEnvironment.createTestEnvironments(AuthenticatorPluginWithSSLTest.class).stream()
        ...
        return Each.parallel(
                        AuthenticatorPluginWithSSLTest.class.getName(),
                        environments,
                        environment -> instance(
                                        environment.name(), () -> new AuthenticatorPluginWithSSLTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        AuthenticatorPluginWithSSLTest.class,
                                                        AuthenticatorPluginWithSSLTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                AuthenticatorPluginWithSSLTest.class,
                                                                AuthenticatorPluginWithSSLTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                AuthenticatorPluginWithSSLTest.class,
                                                                AuthenticatorPluginWithSSLTest
                                                                        ::testDefaultTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        AuthenticatorPluginWithSSLTest.class,
                                                        AuthenticatorPluginWithSSLTest::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(AuthenticatorPluginWithSSLTest.class, javaDockerImage, mode, metrics);
    }
}
