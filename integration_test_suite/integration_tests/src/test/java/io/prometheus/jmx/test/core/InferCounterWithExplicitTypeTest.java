...
public class InferCounterWithExplicitTypeTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        InferCounterWithExplicitTypeTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(InferCounterWithExplicitTypeTest.class),
                        environment -> instance(
                                        environment.name(), () -> new InferCounterWithExplicitTypeTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        InferCounterWithExplicitTypeTest.class,
                                                        InferCounterWithExplicitTypeTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                InferCounterWithExplicitTypeTest.class,
                                                                InferCounterWithExplicitTypeTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                InferCounterWithExplicitTypeTest.class,
                                                                InferCounterWithExplicitTypeTest
                                                                        ::testDefaultTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        InferCounterWithExplicitTypeTest.class,
                                                        InferCounterWithExplicitTypeTest::tearDown)))))
                .build();
    }

    private InferCounterWithExplicitTypeTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(InferCounterWithExplicitTypeTest.class, javaDockerImage, mode, metrics);
    }
}
