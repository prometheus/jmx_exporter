...
public class MetricsPathConfigurationTest {
    ...
    private MetricsPathConfigurationTest(JmxExporterTestEnvironment environment) {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        ...
                        environment -> instance(environment.name(), () -> new MetricsPathConfigurationTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(MetricsPathConfigurationTest.class, javaDockerImage, mode, metrics);
    }
}
