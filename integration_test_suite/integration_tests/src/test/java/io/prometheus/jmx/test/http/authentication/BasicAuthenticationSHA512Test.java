...
public class BasicAuthenticationSHA512Test {
                        ...
                        environment -> instance(
                                ...
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        BasicAuthenticationSHA512Test.class,
                                                        BasicAuthenticationSHA512Test::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                BasicAuthenticationSHA512Test.class,
                                                                BasicAuthenticationSHA512Test::testHealthy)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        BasicAuthenticationSHA512Test.class,
                                                        BasicAuthenticationSHA512Test::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(BasicAuthenticationSHA512Test.class, javaDockerImage, mode, metrics);
    }
}
