...
public class EnvironmentVariablesConfigurationTest {
    ...
    public static Action actionFactory() {
        return Parallel.of(
                ...
                OpenTelemetryTestEnvironment.createEnvironments()
                        .map(EnvironmentVariablesConfigurationTest::createLifecycleAction)
                        .toList());
    }
    ...
    private static Action createLifecycleAction(OpenTelemetryTestEnvironment openTelemetryTestEnvironment) {
        ...
        Action testPrometheusHasMetrics =
                Direct.of("testPrometheusHasMetrics", EnvironmentVariablesConfigurationTest::testPrometheusHasMetrics);

        Action tests = DependentSequential.of("tests", List.of(testPrometheusHasMetrics));

        return Lifecycle.of(
                openTelemetryTestEnvironment.getName(),
                Direct.of("setUp", context -> setUp(context, openTelemetryTestEnvironment)),
                tests,
                Direct.of("tearDown", EnvironmentVariablesConfigurationTest::tearDown));
    }
    ...
    private static void setUp(Context context, OpenTelemetryTestEnvironment openTelemetryTestEnvironment)
        ...
        network.getId();
        prometheusTestEnvironment.initialize(EnvironmentVariablesConfigurationTest.class, network);
        prometheusTestEnvironment.waitForReady();
        jmxExporterTestEnvironment.initialize(EnvironmentVariablesConfigurationTest.class, network);
