...
public class BasicAuthenticationPBKDF2WithHmacSHA512Test {
                        ...
                        environment -> instance(
                                ...
                                .body(scope("scenario")
                                        .before(step(
                                                ...
                                                withInstance(
                                                        BasicAuthenticationPBKDF2WithHmacSHA512Test.class,
                                                        BasicAuthenticationPBKDF2WithHmacSHA512Test::setUp)))
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        BasicAuthenticationPBKDF2WithHmacSHA512Test.class,
                                                        BasicAuthenticationPBKDF2WithHmacSHA512Test::tearDown)))))
                .build();
    }
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(BasicAuthenticationPBKDF2WithHmacSHA512Test.class, javaDockerImage, mode, metrics);
    }
}
