...
public final class PrometheusDockerImages {
    ...
    private static final String DOCKER_IMAGES_RESOURCE = "/prometheus-docker-images.txt";
    ...
    public static Collection<String> names(Predicate<String> predicate) {
        ...
        synchronized (PrometheusDockerImages.class) {
            ...
            bufferedReader =
                    new BufferedReader(
                            new InputStreamReader(
                                    PrometheusDockerImages.class.getResourceAsStream(resource),
