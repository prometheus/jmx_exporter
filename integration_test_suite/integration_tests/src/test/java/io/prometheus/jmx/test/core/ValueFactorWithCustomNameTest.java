...
public class ValueFactorWithCustomNameTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        ValueFactorWithCustomNameTest.class.getName(),
                        JmxExporterTestEnvironment.createTestEnvironments(ValueFactorWithCustomNameTest.class),
                        environment -> instance(
                                        environment.name(), () -> new ValueFactorWithCustomNameTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        ValueFactorWithCustomNameTest.class,
                                                        ValueFactorWithCustomNameTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                ValueFactorWithCustomNameTest.class,
                                                                ValueFactorWithCustomNameTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                ValueFactorWithCustomNameTest.class,
                                                                ValueFactorWithCustomNameTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                ValueFactorWithCustomNameTest.class,
                                                                ValueFactorWithCustomNameTest
                                                                        ::testOpenMetricsTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        ValueFactorWithCustomNameTest.class,
                                                        ValueFactorWithCustomNameTest::tearDown)))))
                .build();
    }

    private ValueFactorWithCustomNameTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(ValueFactorWithCustomNameTest.class, javaDockerImage, mode, metrics);
    }
}
