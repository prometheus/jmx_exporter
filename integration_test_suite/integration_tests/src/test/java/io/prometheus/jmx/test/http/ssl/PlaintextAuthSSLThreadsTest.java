...
public class PlaintextAuthSSLThreadsTest {
    ...
    public static Action factory() throws Throwable {
        var environments = JmxExporterTestEnvironment.createTestEnvironments(PlaintextAuthSSLThreadsTest.class).stream()
        ...
        return Each.parallel(
                        PlaintextAuthSSLThreadsTest.class.getName(),
                        environments,
                        environment -> instance(environment.name(), () -> new PlaintextAuthSSLThreadsTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        PlaintextAuthSSLThreadsTest.class,
                                                        PlaintextAuthSSLThreadsTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                PlaintextAuthSSLThreadsTest.class,
                                                                PlaintextAuthSSLThreadsTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                PlaintextAuthSSLThreadsTest.class,
                                                                PlaintextAuthSSLThreadsTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                PlaintextAuthSSLThreadsTest.class,
                                                                PlaintextAuthSSLThreadsTest
                                                                        ::testOpenMetricsTextMetrics)))
                                                .child(step(
                                        ...
                                        .after(step(
                                                ...
                                                withInstance(
                                                        PlaintextAuthSSLThreadsTest.class,
                                                        PlaintextAuthSSLThreadsTest::tearDown)))))
                .build();
    }

    private PlaintextAuthSSLThreadsTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(PlaintextAuthSSLThreadsTest.class, javaDockerImage, mode, metrics);
    }
}
