...
public class InferCounterTypeFromNameTest {
    ...
    public static Action factory() throws Throwable {
        return Each.parallel(
                        ...
                        environment -> instance(environment.name(), () -> new InferCounterTypeFromNameTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(InferCounterTypeFromNameTest.class, javaDockerImage, mode, metrics);
    }
}
