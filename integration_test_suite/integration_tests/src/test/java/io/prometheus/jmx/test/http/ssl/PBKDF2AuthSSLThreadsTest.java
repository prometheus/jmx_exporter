...
public class PBKDF2AuthSSLThreadsTest {
    ...
    public static Action factory() throws Throwable {
        var environments = JmxExporterTestEnvironment.createTestEnvironments(PBKDF2AuthSSLThreadsTest.class).stream()
        ...
        return Each.parallel(
                        PBKDF2AuthSSLThreadsTest.class.getName(),
                        environments,
                        environment -> instance(environment.name(), () -> new PBKDF2AuthSSLThreadsTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
                                                        PBKDF2AuthSSLThreadsTest.class,
                                                        PBKDF2AuthSSLThreadsTest::setUp)))
                                        .body(sequential("tests")
                                                .child(step(
                                                        "testHealthy()",
                                                        withInstance(
                                                                PBKDF2AuthSSLThreadsTest.class,
                                                                PBKDF2AuthSSLThreadsTest::testHealthy)))
                                                .child(step(
                                                        "testDefaultTextMetrics()",
                                                        withInstance(
                                                                PBKDF2AuthSSLThreadsTest.class,
                                                                PBKDF2AuthSSLThreadsTest::testDefaultTextMetrics)))
                                                .child(step(
                                                        "testOpenMetricsTextMetrics()",
                                                        withInstance(
                                                                PBKDF2AuthSSLThreadsTest.class,
                                                                PBKDF2AuthSSLThreadsTest::testOpenMetricsTextMetrics)))
                                                .child(step(
                                                        "testPrometheusTextMetrics()",
                                                        withInstance(
                                                                PBKDF2AuthSSLThreadsTest.class,
                                                                PBKDF2AuthSSLThreadsTest::testPrometheusTextMetrics)))
                                                .child(step(
                                                        "testPrometheusProtobufMetrics()",
                                                        withInstance(
                                                                PBKDF2AuthSSLThreadsTest.class,
                                                                PBKDF2AuthSSLThreadsTest
                                                                        ::testPrometheusProtobufMetrics))))
                                        .after(step(
                                                "tearDown()",
                                                withInstance(
                                                        PBKDF2AuthSSLThreadsTest.class,
                                                        PBKDF2AuthSSLThreadsTest::tearDown)))))
                .build();
    }

    private PBKDF2AuthSSLThreadsTest(JmxExporterTestEnvironment environment) {
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(PBKDF2AuthSSLThreadsTest.class, javaDockerImage, mode, metrics);
    }
}
