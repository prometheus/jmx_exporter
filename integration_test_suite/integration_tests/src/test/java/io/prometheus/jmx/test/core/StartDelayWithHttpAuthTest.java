...
public class StartDelayWithHttpAuthTest {
    ...
    public static Action factory() throws Throwable {
        ...
        return Each.parallel(
                        ...
                        environments,
                        environment -> instance(environment.name(), () -> new StartDelayWithHttpAuthTest(environment))
                                .body(scope("scenario")
                                        .before(step(
                                                "setUp()",
                                                withInstance(
    ...
    private void assertMetricsResponse(HttpResponse httpResponse, MetricsContentType metricsContentType) {
        ...
        assertMetrics(StartDelayWithHttpAuthTest.class, javaDockerImage, mode, metrics);
    }
}
