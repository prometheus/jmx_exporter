...
blacklistPatterns | A list of Regular Expressions (https://docs.oracle.com/javase/7/docs/api/java/util/regex/Pattern.html) that remove discovered canonical ObjectNames from list of reported metrics.
