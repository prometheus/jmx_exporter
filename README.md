...
To connect to a remote Wildfly instance, please use `jmx_prometheus_httpserver-*-jar-with-dependencies-wfly.jar`, which should be automatically created at build.
